...
from conf import MAX_POOL_K_SIZE, MAX_POOL_PADDING, MAX_POOL_STRIDE, CONVOLUTION_K_SIZE, CONVOLUTION_PADDING, \
    CONVOLUTION_STRIDE, OUT_CHANNEL, IN_CHANNEL, LEARNING_RATE, INPUT_DIMENSION_RNN, HIDDEN_DIMENSION_RNN, CCN_PARAMETERS
...
class CaptionGenerator:
    ...
    def save_cnn_parameters(self):
        ...
        torch.save(cnn_parameters, CCN_PARAMETERS)
