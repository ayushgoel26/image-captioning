...
input_shapes = [[in_channel[0], 112, 112], [in_channel[1], 56, 56], [in_channel[2], 28, 28], [in_channel[3], 14, 14],
                [in_channel[4], 7, 7]]

convLayer1 = Convolution(in_channels=in_channel[0], out_channels=out_channel[0], kernel_size=convKSize,
                         padding=convPadding, stride=convStride, input_shape=input_shapes[0])
mxPoolLayer1 = Maxpool(mxPoolKSize, stride=mxPoolStride, padding=mxPoolPadding)

convLayer2 = Convolution(in_channels=in_channel[1], out_channels=out_channel[1], kernel_size=convKSize,
                         padding=convPadding, stride=convStride, input_shape=input_shapes[1])
mxPoolLayer2 = Maxpool(mxPoolKSize, stride=mxPoolStride, padding=mxPoolPadding)

convLayer3 = Convolution(in_channels=in_channel[2], out_channels=out_channel[2], kernel_size=convKSize,
                         padding=convPadding, stride=convStride, input_shape=input_shapes[2])
mxPoolLayer3 = Maxpool(mxPoolKSize, stride=mxPoolStride, padding=mxPoolPadding)

convLayer4 = Convolution(in_channels=in_channel[3], out_channels=out_channel[3], kernel_size=convKSize,
                         padding=convPadding, stride=convStride, input_shape=input_shapes[3])
mxPoolLayer4 = Maxpool(mxPoolKSize, stride=mxPoolStride, padding=mxPoolPadding)

convLayer5 = Convolution(in_channels=in_channel[4], out_channels=out_channel[4], kernel_size=convKSize,
                         padding=convPadding, stride=convStride, input_shape=input_shapes[4])
